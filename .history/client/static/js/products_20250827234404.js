...
function productCardHTML(p) {
  ...
  const imageUrl = p.image ? p.image : "../assets/products-img/default.png";
...
async function fetchProducts() {
    try {
        ...
        if (grid) {
            grid.innerHTML = '<p style="text-align:center; color: red;">Failed to load products. Please check the backend server.</p>';
        }
    }
}
fetchProducts();