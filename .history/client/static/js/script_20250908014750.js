...
fetch("http://127.0.0.1:8000/api/featured-products/")   // <-- your Django API endpoint
  .then(res => res.json())
  .then(products => {
    const carouselTrack = document.querySelector(".carousel-track");
    carouselTrack.innerHTML = ""; // clear before adding
    ...
    // ✅ Reinitialize carousel if needed (arrows, swipe, etc.)
    initCarousel();
  })
...
async function fetchPopular() {
  const API_URL = "http://127.0.0.1:8000/api/featured-products/"; // <-- replace with your API
  // show a basic loader
